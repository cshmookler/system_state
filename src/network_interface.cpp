...
res::optional_t<std::list<network_interface_t>> network_interface_t::all() {
...
res::optional_t<bool> network_interface_t::physical() const {
    fs::path real_path;
    try {
...
res::optional_t<bool> network_interface_t::loopback() const {
...
res::optional_t<network_interface_t::status_t> network_interface_t::status()
  const {
...
res::optional_t<network_interface_t::stat_t> network_interface_t::stat() const {
